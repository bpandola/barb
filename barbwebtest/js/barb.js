...
(function (Barbarian) {
    ...
    (function (Input) {
        ...
        var HudState = (function () {
            function HudState(iconSelected) {
                this.iconState2 = 0;
...
(function (Barbarian) {
    ...
    var Hud = (function (_super) {
        ...
        function Hud(game, key, x, y) {
            ...
            this.weaponIcons = [];
            this.heroIcons = [];
            this.iconSelected = Barbarian.Input.Icons.None;
            this.iconHitBoxes = {};
            this.x = x;
            this.y = y;
            ...
            this.iconHitBoxes[Barbarian.Input.Icons.Left.toString()] = { icon: Barbarian.Input.Icons.Left, hitBox: new Phaser.Rectangle(0, 320, 40, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Up.toString()] = { icon: Barbarian.Input.Icons.Up, hitBox: new Phaser.Rectangle(40, 320, 80, 40) };
            this.iconHitBoxes[Barbarian.Input.Icons.Down.toString()] = { icon: Barbarian.Input.Icons.Down, hitBox: new Phaser.Rectangle(40, 360, 80, 40) };
            this.iconHitBoxes[Barbarian.Input.Icons.Right.toString()] = { icon: Barbarian.Input.Icons.Right, hitBox: new Phaser.Rectangle(120, 320, 40, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Stop.toString()] = { icon: Barbarian.Input.Icons.Stop, hitBox: new Phaser.Rectangle(160, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Jump.toString()] = { icon: Barbarian.Input.Icons.Jump, hitBox: new Phaser.Rectangle(240, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Run.toString()] = { icon: Barbarian.Input.Icons.Run, hitBox: new Phaser.Rectangle(320, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Attack.toString()] = { icon: Barbarian.Input.Icons.Attack, hitBox: new Phaser.Rectangle(400, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Defend.toString()] = { icon: Barbarian.Input.Icons.Defend, hitBox: new Phaser.Rectangle(480, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Flee.toString()] = { icon: Barbarian.Input.Icons.Flee, hitBox: new Phaser.Rectangle(560, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Get.toString()] = { icon: Barbarian.Input.Icons.Get, hitBox: new Phaser.Rectangle(640, 320, 80, 80) };
            this.iconHitBoxes[Barbarian.Input.Icons.Use.toString()] = { icon: Barbarian.Input.Icons.Stop, hitBox: new Phaser.Rectangle(720, 320, 80, 80) };
        }
        Hud.prototype.getState = function () {
            var state = new Barbarian.Input.HudState(this.iconSelected);
        ...
        Hud.prototype.update = function () {
            this.forEach(function (part) {
                if (part.animations.currentFrame.name.startsWith("DIGIT")) {
                    part.kill();
                }
            }, this);
            this.render();
